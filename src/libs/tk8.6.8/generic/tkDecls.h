...
/* 276 */
EXTERN void *		Tk_CanvasDispFunc(Tk_function display_func);
/* 277 */
...
typedef struct TkStubs {
    ...
    void * (*tk_CanvasScrollbarFunc) (Tk_function scrollbar_func); /* 275 */
    void * (*tk_CanvasDispFunc) (Tk_function display_func); /* 276 */
...
#define Tk_CanvasScrollbarFunc \
	(tkStubsPtr->tk_CanvasScrollbarFunc) /* 275 */
#define Tk_CanvasDispFunc \
	(tkStubsPtr->tk_CanvasDispFunc) /* 276 */
