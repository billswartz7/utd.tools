...
const Tcl_ObjType *Tcl_GetTclIntType( void )
{
    return (&tclIntType) ;
} /* end Tcl_GetTclDoubleType() */

const Tcl_ObjType *Tcl_GetTclDoubleType( void )
{
    return (&tclDoubleType) ;
} /* end Tcl_GetTclDoubleType() */

const Tcl_ObjType *Tcl_GetTclListType( void )
{
    return(&tclListType) ;
} /* end Tcl_GetTclListType() */

const Tcl_ObjType *Tcl_GetTclDictType( void )
{
    return(&tclDictType) ;
} /* end Tcl_GetTclDictType() */
