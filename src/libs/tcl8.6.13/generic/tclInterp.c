...
" 	lappend try_dirs $env(UTDTOOLS)/$env(UTDTOOLSVERSION)/lib/tcl8.6\n"
"    } else {\n"
"       set msg \"UTD tools environment variables:\n\"\n"
"       append msg \"UTDTOOLS and UTDTOOLSVERSION are not set.\n\"\n"
"       error $msg\n"
"    }\n"
"    set errors {}\n"
