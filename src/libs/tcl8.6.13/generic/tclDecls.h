...
/* 631 */
EXTERN int		Tcl_ChannelHandlerExists(Tcl_Channel chan,
				Tcl_ChannelProc *proc, ClientData clientData,
				int options);
/* 632 */
EXTERN int		Tcl_RenameObjCmd(ClientData clientData,
				Tcl_Interp *interp, int objc,
				Tcl_Obj *const objv[]);
...
typedef struct TclStubs {
    ...
    int (*tcl_ParseArgsObjv) (Tcl_Interp *interp, const Tcl_ArgvInfo *argTable, int *objcPtr, Tcl_Obj *const *objv, Tcl_Obj ***remObjv, int flags); /* 604 */
    ...
    int (*tcl_ChannelHandlerExists) (Tcl_Channel chan, Tcl_ChannelProc *proc, ClientData clientData, int options); /* 631 */
    int (*tcl_RenameObjCmd) (ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *const objv[]); /* 632 */
...
#define Tcl_ChannelHandlerExists \
	(tclStubsPtr->tcl_ChannelHandlerExists) /* 631 */
#define Tcl_RenameObjCmd \
	(tclStubsPtr->tcl_RenameObjCmd) /* 632 */
/* Slot 633 is reserved */
/* Slot 634 is reserved */
/* Slot 635 is reserved */
/* Slot 636 is reserved */
