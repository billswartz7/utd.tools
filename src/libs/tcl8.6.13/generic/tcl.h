...
typedef enum {
  ...
  TCL_SERVICED_EVENT 	= (1<<6)
} TCL_EVENT_TYPE_T ;
#define TCL_ALL_EVENTS		(~TCL_DONT_WAIT^TCL_SERVICED_EVENT)
#define TCL_SELECT_RETURN	TCL_SERVICED_EVENT
...
#define TCL_ARGV_NO_OPTIONS		0x0
...
EXTERN const Tcl_ObjType *Tcl_GetTclIntType( void ) ;
EXTERN const Tcl_ObjType *Tcl_GetTclDoubleType( void ) ;
EXTERN const Tcl_ObjType *Tcl_GetTclListType( void ) ;
EXTERN const Tcl_ObjType *Tcl_GetTclDictType( void ) ;
