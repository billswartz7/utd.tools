...
declare 604 {
    int Tcl_ParseArgsObjv(Tcl_Interp *interp, const Tcl_ArgvInfo *argTable,
	    int *objcPtr, Tcl_Obj *const *objv, Tcl_Obj ***remObjv,int flags)
}
...
# TimberWolf new functions
declare 631 {
    int Tcl_ChannelHandlerExists( Tcl_Channel chan, Tcl_ChannelProc *proc,
	    ClientData clientData, int options)
}
declare 632 {
    int	Tcl_RenameObjCmd(ClientData clientData, Tcl_Interp *interp, int objc,
			    Tcl_Obj *const objv[])
}
