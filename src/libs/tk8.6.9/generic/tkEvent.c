 ...
 *----------------------------------------------------------------------
 *
 * Tk_CreateForcedEventHandler --
 *
 *	Arrange for a given function to be invoked whenever events from a
 *	given class occur in a given window. Similar to Tk_CreateEventHandler
 *	but the operation always occurs even if other handlers have been
 *	installed.  Allows outside interaction with Tk events.
 *
 * Results:
 *	None.
 *
