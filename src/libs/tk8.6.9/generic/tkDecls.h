...
EXTERN void		Tk_CreateOldPhotoImageFormat(
				const Tk_PhotoImageFormat *formatPtr);
/* 274 */
EXTERN void		Tk_CreateForcedEventHandler(Tk_Window token,
				unsigned long mask, Tk_EventProc *proc,
				ClientData clientData);
...
typedef struct TkStubs {
    ...
    void (*tk_CreateForcedEventHandler) (Tk_Window token, unsigned long mask, Tk_EventProc *proc, ClientData clientData); /* 274 */
    void (*reserved275)(void);
    void (*reserved276)(void);
    void (*tk_CanvasDispUpdate) (void); /* 277 */
    int (*tk_UpdateObjCmd) (ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *const objv[]); /* 278 */
    void (*tkWmParasiteConfigNotify) (Tk_Window tkwin); /* 279 */
    int (*tk_XBusy) (int flag); /* 280 */
    int (*tk_MappedWindow) (Tk_Window tkwin); /* 281 */
} TkStubs;
...
#define Tk_CreateForcedEventHandler \
	(tkStubsPtr->tk_CreateForcedEventHandler) /* 274 */
/* Slot 275 is reserved */
/* Slot 276 is reserved */
#define Tk_CanvasDispUpdate \
	(tkStubsPtr->tk_CanvasDispUpdate) /* 277 */
#define Tk_UpdateObjCmd \
	(tkStubsPtr->tk_UpdateObjCmd) /* 278 */
#define TkWmParasiteConfigNotify \
	(tkStubsPtr->tkWmParasiteConfigNotify) /* 279 */
#define Tk_XBusy \
	(tkStubsPtr->tk_XBusy) /* 280 */
#define Tk_MappedWindow \
	(tkStubsPtr->tk_MappedWindow) /* 281 */
