...
/* 172 */
EXTERN int		Tk_SizeOfBitmap(Display *display, Pixmap bitmap,
...
EXTERN void		Tk_CreateOldPhotoImageFormat(
				const Tk_PhotoImageFormat *formatPtr);
/* 274 */
EXTERN int		Tk_XBusy(int flag);
/* 275 */
EXTERN void		TkWmParasiteConfigNotify(Tk_Window tkwin);
/* 276 */
EXTERN int		TkCopyRecordAndGlobalEval(Tcl_Interp *interp,
				char *script);
/* Slot 277 is reserved */
/* 278 */
EXTERN void		Tk_DisplayButton(ClientData clientData);
/* 279 */
EXTERN void		Tk_DisplayButtonText(ClientData clientData,
				char *text);
...
/* 283 */
EXTERN int		Tk_CanvasWidgetCmd(ClientData clientData,
				Tcl_Interp *interp, int objc,
				Tcl_Obj *CONST objv[]);
/* 284 */
EXTERN int		Tk_MappedWindow(Tk_Window tkwin);
/* 285 */
...
typedef struct TkStubs {
    ...
    int (*tk_SizeOfBitmap) (Display *display, Pixmap bitmap, int *widthPtr, int *heightPtr); /* 172 */
    ...
    int (*tk_XBusy) (int flag); /* 274 */
    void (*tkWmParasiteConfigNotify) (Tk_Window tkwin); /* 275 */
    int (*tkCopyRecordAndGlobalEval) (Tcl_Interp *interp, char *script); /* 276 */
    void (*reserved277)(void);
    void (*tk_DisplayButton) (ClientData clientData); /* 278 */
    void (*tk_DisplayButtonText) (ClientData clientData, char *text); /* 279 */
    void (*reserved280)(void);
    void (*reserved281)(void);
    void (*tk_CanvasDispUpdate) (void); /* 282 */
    int (*tk_CanvasWidgetCmd) (ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]); /* 283 */
    int (*tk_MappedWindow) (Tk_Window tkwin); /* 284 */
    int (*tk_UpdateObjCmd) (ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]); /* 285 */
...
#define Tk_XBusy \
	(tkStubsPtr->tk_XBusy) /* 274 */
#define TkWmParasiteConfigNotify \
	(tkStubsPtr->tkWmParasiteConfigNotify) /* 275 */
#define TkCopyRecordAndGlobalEval \
	(tkStubsPtr->tkCopyRecordAndGlobalEval) /* 276 */
/* Slot 277 is reserved */
#define Tk_DisplayButton \
	(tkStubsPtr->tk_DisplayButton) /* 278 */
#define Tk_DisplayButtonText \
	(tkStubsPtr->tk_DisplayButtonText) /* 279 */
/* Slot 280 is reserved */
/* Slot 281 is reserved */
#define Tk_CanvasDispUpdate \
	(tkStubsPtr->tk_CanvasDispUpdate) /* 282 */
#define Tk_CanvasWidgetCmd \
	(tkStubsPtr->tk_CanvasWidgetCmd) /* 283 */
#define Tk_MappedWindow \
	(tkStubsPtr->tk_MappedWindow) /* 284 */
#define Tk_UpdateObjCmd \
	(tkStubsPtr->tk_UpdateObjCmd) /* 285 */
/* Slot 286 is reserved */
/* Slot 287 is reserved */
/* Slot 288 is reserved */
/* Slot 289 is reserved */
