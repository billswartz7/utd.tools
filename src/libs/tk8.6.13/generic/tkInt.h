...
MODULE_SCOPE Tk_PhotoImageFormat tkImgFmtWindow;
...
MODULE_SCOPE void 	TkWmParasite(TkWindow *winPtr) ;
MODULE_SCOPE void 	Tk_CreateParasiteTopLevel(Tk_Window tkwin, Window window) ;
...
MODULE_SCOPE char *	TkImgShrink( char *input, int width, int height ) ;
MODULE_SCOPE char *	TkImgQuantize( char *input ) ;
