...
declare 172 {
    int Tk_SizeOfBitmap(Display *display, Pixmap bitmap, int *widthPtr,
	    int *heightPtr)
}
declare 173 {
...
declare 276 generic {
    int TkCopyRecordAndGlobalEval(Tcl_Interp *interp,char *script)
}
declare 277 generic {
    void TkinstallUserExit( void (*user_routine)(void) )
}
declare 278 generic {
  void Tk_DisplayButton(ClientData clientData)
}
declare 279 generic {
  void Tk_DisplayButtonText(ClientData clientData,char *text)
}
declare 280 generic {
...
declare 283 generic {
  int Tk_CanvasWidgetCmd(ClientData clientData, Tcl_Interp *interp, 
...
declare 285 generic {
  int	Tk_UpdateObjCmd(ClientData clientData,Tcl_Interp *interp, int objc,
			    Tcl_Obj *CONST objv[])
}
