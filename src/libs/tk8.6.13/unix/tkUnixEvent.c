...
static void (*user_exit_routineS)(void) ;
    ...
    TkDisplay *dispPtr)
{
	...
	Tcl_DeleteFileHandler(ConnectionNumber(dispPtr->display));
 	if( user_exit_routineS ){
 	  (*user_exit_routineS)() ;
 	  DisplayExitHandler(NULL) ;
 	}
...
TkDisplay *TkpOpenParasiteDisplay(Display *display)
{
    TkDisplay *dispPtr;
    ...
    return dispPtr;
} /* end TkpOpenParasiteDisplay() */

void TkXtEventSource(void)
{
} /* end TkXtEventSource() */

void TkRestoreXEventSource(void)
{
} /* end TkXtEventSource() */

void TkInstallXtEventSource(void)
{
} /* end TkInstallXtEventSource() */

void TkDeleteXEventSource(void)
{
} /* end TkDelete() */

void TkinstallUserExit( void (*user_routine)(void) )
{
    user_exit_routineS = user_routine ;
} /* end TkinstallUserExit() */

/*
 * Local Variables:
 * mode: c
