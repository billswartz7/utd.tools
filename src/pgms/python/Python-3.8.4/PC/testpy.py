...
try:
  ...
  Please check your UTDPYTHONPATH environment variable.""")
    sys.exit(1)
...
try:
  ...
  a PC, you should add the dos_8x3 directory to your UTDPYTHONPATH.""")
    sys.exit(1)
...
for dir in sys.path:
    ...
    if os.path.isfile(file):
        ...
        if os.path.isdir(test):
            # Add the "test" directory to UTDPYTHONPATH.
