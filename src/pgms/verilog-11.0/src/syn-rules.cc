...
#line 134 "../syn-rules.cc" /* yacc.c:339  */
...
#line 194 "../syn-rules.cc" /* yacc.c:358  */
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 84 "syn-rules.y" /* yacc.c:1663  */
    { make_DFF_CE(des_, (yyvsp[-6])->top, (yyvsp[-3])->event, 0, (yyvsp[-1])->assign);
		}
#line 1269 "../syn-rules.cc" /* yacc.c:1663  */
    break;

  case 3:
#line 88 "syn-rules.y" /* yacc.c:1663  */
    { make_DFF_CE(des_, (yyvsp[-9])->top, (yyvsp[-6])->event, (yyvsp[-3])->expr, (yyvsp[-2])->assign);
		}
#line 1276 "../syn-rules.cc" /* yacc.c:1663  */
    break;


#line 1280 "../syn-rules.cc" /* yacc.c:1663  */
      default: break;
    }
...
#line 95 "syn-rules.y" /* yacc.c:1907  */
