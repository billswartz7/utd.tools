...
/* Command-line: /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/gperf -o -i 7 -C -k '1-4,6,9,$' -H keyword_hash -N check_identifier -t lexor_keyword.gperf  */
