...
__all__ = ['utd_dijkstra_path',
           'dijkstra_path_length',
           'utd_bidirectional_dijkstra',
           'utd_single_source_dijkstra',
           'single_source_dijkstra_path',
           'single_source_dijkstra_path_length',
           'utd_multi_source_dijkstra',
...
def utd_dijkstra_path(G, source, target, weight='weight',turtle_obj=None):
    ...
    """
    (length, path) = utd_single_source_dijkstra(G, source, target=target,
                                            weight=weight,turtle_obj=turtle_obj)
    return path
...
def single_source_dijkstra_path(G, source, cutoff=None, weight='weight',turtle_obj=None):
...
def utd_single_source_dijkstra(G, source, target=None, cutoff=None,
                           weight='weight',turtle_obj=None):
    ...
    single_source_bellman_ford()
    """
    return utd_multi_source_dijkstra(G, {source}, cutoff=cutoff, target=target,
                                 weight=weight,turtle_obj=turtle_obj)
...
def utd_multi_source_dijkstra(G, sources, target=None, cutoff=None,
                          weight='weight',turtle_obj=None):
    ...
    dist = _utd_dijkstra_multisource(G, sources, weight, paths=paths,
                                 cutoff=cutoff, target=target,turtle_obj=turtle_obj)
    if target is None:
        return (dist, paths)
    try:
...
def _utd_dijkstra_multisource(G, sources, weight, pred=None, paths=None,
                          cutoff=None, target=None,turtle_obj=None):
    ...
    while fringe:
        ...
        if turtle_obj != None:
            utd_draw_node( turtle_obj, G, v, 'gray', 30 ) 
        dist[v] = d
        if v == target:
            break
        for u, e in G_succ[v].items():
            ...
            if u in dist:
                ...
                if pred is not None:
                    pred[u].append(v)
        if turtle_obj != None:
            utd_draw_node( turtle_obj, G, v, 'black', 25 ) 
...
def utd_bidirectional_dijkstra(G, source, target, weight='weight',turtle_obj=None):
