...
def main( filename ):
    ...
    print('Hit any key to run bidirectinoal astar search')
    dummy = input()
    turtle.clearscreen()
    turtle.tracer(0,0)
    draw_the_graph( t, new_graph )
    ...
    turtle.tracer(1,25)
    # 
    # Student needs to implement bidirectional astar search
    #  Add your code here
    # astar_nodes = bidirectional_astar( new_graph, source, target, turtle_obj=t )
    astar_nodes.reverse()
